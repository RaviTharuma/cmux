...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .betaFeatures, id: "nestedTopology", title: "Nested Topology", synonyms: "nested topology herdr virtual descendants host surface sidebar beta unstable"),
            .init(
